...
(function() {
  ...
  MatchImageMarkDown = function(src) {
    var alt_, ex, item, items, m, p, r, re1, re2, re3, re4, re5, re6, re7, ref, rest;
    re1 = '(!)';
    re2 = '(\\[)';
    re3 = '(.*?)';
    re4 = '(\\])';
    ...
    while ((m = p.exec(src)) != null) {
      ...
      if (((ref = r[0]) != null ? ref.indexOf("{{BASE_PATH}}") : void 0) === 0) {
        continue;
      }
  ...
  module.exports = Source = (function() {
    ...
    Source.prototype.update = function(callback) {
      var d, i, img, len, newSrc, r, ref, that, timestamp;
      newSrc = this.src;
      ref = this.images;
      ...
      that = this;
      return file.writeFile(this.path, newSrc, function(err) {
        if (err != null) {
